    ...
    return (
      <div className="flex flex-column justify-between vh-100 w-100 avenir">
        ...
        <main className="vh-100 bg-black-30">
          ...
          <div className="pa3">
            You can't always have your vinyl collection with you, but having a
            way to access it anywhere, anytime is a must for any vinyl
            enthusiast. If you're shopping for your collection, you'll need to
            know what you already have and what you're looking for. Happy
            collecting!
          </div>
        </main>
      </div>
